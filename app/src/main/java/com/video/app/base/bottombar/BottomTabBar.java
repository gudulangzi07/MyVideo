...
import com.video.app.base.bottombar.animate.Animatable;
import com.video.app.base.bottombar.animate.FlipAnimater;
import com.video.app.base.bottombar.animate.JumpAnimater;
import com.video.app.base.bottombar.animate.RotateAnimater;
import com.video.app.base.bottombar.animate.ScaleAnimater;
import com.video.app.base.bottombar.anno.NorIcons;
import com.video.app.base.bottombar.anno.SeleIcons;
import com.video.app.base.bottombar.anno.Titles;
import com.video.app.utils.DensityUtil;
        ...
        if (!isInEditMode()) {
            ...
            for (int i = 0; i < mBottomTabItems.length; i++) {
                ...
                mBottomTabItems[i] = new BottomTabItem.Builder(mContext).setTitle(mTitles == null ? null : mTitles[i]).setIndex(temp).setTextSize(textSize)
                        ...
                        .setSelectIcon(mSelectedIcons == null ? null : mSelectedIcons[i]).build();
