...
import com.video.app.base.bottombar.badgeview.BadgeRelativeLayout;
import com.video.app.base.bottombar.badgeview.Badgeable;
import com.video.app.base.bottombar.badgeview.DragDismissDelegate;
...
public class BottomTabItem extends BadgeRelativeLayout {
    ...
    static class Builder {
        ...
        Builder setNormalIcon(@DrawableRes int drawable) {
            this.normalIcon = drawable;
            return this;
        }

        Builder setSelectIcon(@DrawableRes int drawable) {
